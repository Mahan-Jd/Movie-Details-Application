...
<div class="details-bottom">
  ...
  <div class="list-group">${movie.production_companies.map((prod) => `<span>${prod.name}</span>`
...
<div class="details-bottom">
  ...
  <h4>Production Companies</h4>
  <div class="list-group">${show.production_companies.map((prod) => `<span>${prod.name}</span>`
